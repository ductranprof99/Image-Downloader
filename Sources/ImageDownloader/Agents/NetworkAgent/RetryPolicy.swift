...
public struct RetryPolicy {
    ...
    /// Aggressive retry policy (5 retries, 0.5s base delay, 1.5x multiplier)
...
@objc public class IDRetryPolicy: NSObject {
    ...
    @objc public static func nonePolicy() -> IDRetryPolicy {
        return IDRetryPolicy(maxRetries: 0, baseDelay: 0.0, backoffMultiplier: 1.0, maxDelay: 0.0)
    }
